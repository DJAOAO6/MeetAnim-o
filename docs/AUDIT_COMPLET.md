...
**Ce qui reste inchangé, volontairement** : la couverture de tests (toujours partielle, P2-30 dans FIX_PLAN.md) et le passage Lighthouse en mode production n'ont pas été traités. Rappels (P2-23) et Statistiques (P2-24) sont désormais tous les deux réellement fonctionnels (décision produit du 2026-08-30) — quelques sections de Statistiques sans aucune donnée réelle en base (avis clients, zones douloureuses, pathologies, stérilisation) ont été retirées plutôt que gardées fictives. Le Sprint 4 (P2-23, P2-24, P2-25, cohérence visuelle) est maintenant terminé — voir `FIX_PLAN.md` pour le détail.

68 % reflète l'état à l'issue du Sprint 1 (P0/P1). Depuis (Sprints 2 à 4, 2026-08-29 → 2026-08-30) : accessibilité/UX affinées, dette de qualité/performance résorbée, couverture de tests E2E ajoutée sur les parcours critiques, et surtout Rappels (P2-23) et Statistiques (P2-24) sont sortis du statut « zone assumée comme non finie » — les deux sont désormais réellement fonctionnels de bout en bout sur données réelles. Ce score n'a pas été recalculé formellement depuis le Sprint 1 ; le détail fiche par fiche ci-dessous et dans `FIX_PLAN.md` fait foi de l'état actuel, plus à jour que ce pourcentage global.
