...
export default defineConfig({
  ...
  projects: [
    ...
    { name: "setup", testMatch: /auth\.setup\.ts/ },
    {
      ...
      testIgnore: /(auth\.setup|dashboard-layout|accessibility-dashboard|responsive-mobile|agenda-touch-drag|public-page-editor|responsive-widths|notifications-toasts|business-profile-geocoding|availability-manager)\.(spec\.)?ts/,
      use: { ...devices["Desktop Chrome"] },
    },
    {
      name: "chromium-connecte",
      testMatch: /(dashboard-layout|accessibility-dashboard|public-page-editor|responsive-widths|notifications-toasts|business-profile-geocoding|availability-manager)\.spec\.ts/,
      dependencies: ["setup"],
