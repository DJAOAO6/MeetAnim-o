export type PermissionKey = "DELETE_CLIENTS" | "VIEW_FINANCES" | "MANAGE_PUBLIC_SETTINGS";

export const permissionKeys: PermissionKey[] = ["DELETE_CLIENTS", "VIEW_FINANCES", "MANAGE_PUBLIC_SETTINGS"];
