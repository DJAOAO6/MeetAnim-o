...
export const tourAppointments: Record<string, TourAppointment[]> = {
  ...
  "tour-rouen-nord": [
    ...
    { id: "rn-3", time: "15:00", animalName: "Milo", service: "Ostéopathie féline", city: "Bihorel", clientName: "Claire Petit", position: { x: 70, y: 35 } },
  ],
  "tour-dieppe": [
...
export const mapClients: MapClient[] = [
  {
    ...
    city: "Rouen",
    lastConsultation: "12 août 2026",
    nextReminder: "12 février 2027",
  ...
  },
  {
    ...
    nextReminder: "18 septembre 2026",
    dueForReminder: true,
    avatar: "🐴",
    position: { x: 69, y: 20 },
  },
  {
    ...
    breed: "Lapin nain",
    city: "Bois-Guillaume",
    lastConsultation: "2 juillet 2026",
    nextReminder: "2 janvier 2027",
    dueForReminder: false,
    avatar: "🐇",
    position: { x: 70, y: 48 },
  },
