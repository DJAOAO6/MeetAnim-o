  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      <div role="group" aria-label="Légende et filtre des rendez-vous" className="flex flex-wrap items-center gap-2">
        {chips.map((option) => {
          ...
          return (
            <button
              ...
              className={`inline-flex min-h-9 items-center gap-2 rounded-full border px-3 text-xs font-extrabold transition ${
        ...
        <span className="inline-flex min-h-9 items-center gap-2 rounded-full bg-animeo-bg px-3 text-xs font-extrabold text-animeo-muted">
      ...
      {help.length ? (
        <span className="group relative inline-flex">
          <button
            ...
            className="flex h-9 w-9 items-center justify-center rounded-full text-animeo-muted transition hover:bg-animeo-bg hover:text-animeo-dark focus-visible:outline-2 focus-visible:outline-animeo"
          >
